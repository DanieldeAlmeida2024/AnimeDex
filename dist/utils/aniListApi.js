...
exports.getAnimeFromAniList = exports.getImdbIdFromAniList = void 0;
 ...
 */
async function getImdbIdFromAniList(animeName, desiredStremioType) {
    const query = `
        query ($search: String) {
...
async function getAnimeFromAniList(animeName, secoundName, desiredStremioType) {
    animeName = animeName
