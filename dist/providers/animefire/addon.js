...
function animeFireMetaHeadler(decodedAnimefireUrl, type) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (shouldScrape) {
            ...
            const details = yield (0, animeFireScraper_1.scrapeAnimeDetails)(animefireUrlToUse);
            if (details) {
                ...
                try {
                    anime = yield prisma.anime.upsert({
                        ...
                        update: {
                            title: (_a = details.title) !== null && _a !== void 0 ? _a : anime === null || anime === void 0 ? void 0 : anime.title,
                        ...
                        create: {
                            title: (_c = details.title) !== null && _c !== void 0 ? _c : 'Unknown Title',
                            type: type,
                            animefireUrl: animefireUrlToUse,
                            stremioId: animefireUrlToUse, // Garanta que o stremioId está aqui
                            imdbId: (anime === null || anime === void 0 ? void 0 : anime.imdbId) || '',
                            description: details.description,
                            genres: genresAsString,
                            releaseYear: details.releaseYear,
                            background: details.background,
        ...
        if (type === 'series' && episodesFromDb.length > 0) {
            ...
            console.log(`[MetaHandler Interno] Exemplo de ID de vídeo (episódio 1): ${encodeURIComponent(animefireUrlToUse)}:S${(_e = (_d = episodesFromDb[0]) === null || _d === void 0 ? void 0 : _d.season) !== null && _e !== void 0 ? _e : 1}E${(_g = (_f = episodesFromDb[0]) === null || _f === void 0 ? void 0 : _f.episode) !== null && _g !== void 0 ? _g : 1}`);
        }
        const meta = {
            id: `animefire_${type}_`,
            type: anime.type,
            name: anime.title,
            poster: (_h = anime.poster) !== null && _h !== void 0 ? _h : undefined,
            description: (_j = anime.description) !== null && _j !== void 0 ? _j : undefined,
            genres: genresAsArray,
            releaseInfo: (_k = anime.releaseYear) === null || _k === void 0 ? void 0 : _k.toString(),
            background: (_l = anime.background) !== null && _l !== void 0 ? _l : undefined,
