...
const tmdb_ts_1 = require("tmdb-ts");
const url_1 = require("./constants/url");
const darkmahouScraper_1 = require("./services/darkmahouScraper");
const tmdb = new tmdb_ts_1.TMDB("07a3487ea23ce152789ad52a20a5a97f");
const BASE_URL = url_1.TORRENT_ANIME_URL;
function darkmahouTorrentHeadler(animeTitle, season, episode) {
    return __awaiter(this, void 0, void 0, function* () {
        const streams = yield (0, darkmahouScraper_1.searchAnimeTorrents)(animeTitle, season, episode);
        if (streams.length === 0) {
